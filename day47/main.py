...
live_url = [
    "https://www.amazon.in/Portronics-Wireless-Bluetooth-Connectivity-Rechargeable/dp/B0BG8LZNYL?th=1",
    "https://www.amazon.in/Aluminium-Ergonomic-Adjustable-Tabletop-Compatible/dp/B0F7B1W5MN?th=1",
]
header = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36",
    "Accept-Language": "en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7",
}
TRAGETED_BUYING_PRICE = [630, 250]
for num in range(0, 2):
    ...
    # print(title)
    if price_as_float < TRAGETED_BUYING_PRICE[num]:
        ...
        result = connection.login(
            user=os.environ["MY_EMAIL"], password=os.environ["PASSWORD"]
        )
        connection.sendmail(
