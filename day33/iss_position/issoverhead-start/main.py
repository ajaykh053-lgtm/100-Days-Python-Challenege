...
# print(iss_longitude)
#If you wanna run this code then uncomment below two lines
...
while True:
    ...
    #you dumb you dont konw how to code thats why your adding comments ok 
    # comment upper three lines and reindent the below all lines to work the code 
    # is_iss_overhead()
    # is_night()
