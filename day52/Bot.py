...
class InstaFollower:
    ...
    def login(self):
        ...
        sleep(1)
        Login_btn = self.driver.find_element(by=By.CSS_SELECTOR,value=".naan-btn-primary")
        Login_btn.click()
        self.wait.until(ec.presence_of_all_elements_located((By.CLASS_NAME,"naan-popup-card")))
        self.save_credentail = self.driver.find_element(by=By.CLASS_NAME,value="naan-popup-dismiss")
        self.driver.execute_script("arguments[0].click();",self.save_credentail)
        sleep(1)
        self.wait.until(ec.presence_of_all_elements_located((By.CLASS_NAME,"naan-popup-overlay")))
        self.dismiss_notification = self.driver.find_element(by=By.CLASS_NAME,value="naan-popup-dismiss")
    ...
    def find_followers(self):
        ...
        sleep(2)
        self.chefsteps = self.driver.find_element(by=By.XPATH,value="/html/body/aside/div[4]/a[1]")
        self.driver.execute_script("arguments[0].click();",self.chefsteps)
        self.wait.until(ec.presence_of_all_elements_located((By.CLASS_NAME,"naan-center")))
